...
public class GateSpawner : MonoBehaviour
{
    ...
    public void SpawnThings()
    {
        ...
        Instantiate(gatePrefabs[Random.Range(0, gatePrefabs.Length)], new Vector3(1.347f, 2.211f, 6.859f), Quaternion.identity);
        Instantiate(gatePrefabs[Random.Range(0, gatePrefabs.Length)], new Vector3(2.342f, 2.211f, 6.859f), Quaternion.identity);
        ...
        Instantiate(gatePrefabs[Random.Range(0, gatePrefabs.Length)], new Vector3(1.347f, 2.211f, 18.88f), Quaternion.identity);
        Instantiate(gatePrefabs[Random.Range(0, gatePrefabs.Length)], new Vector3(2.342f, 2.211f, 18.88f), Quaternion.identity);
        ...
        Instantiate(gatePrefabs[Random.Range(0, gatePrefabs.Length)], new Vector3(1.347f, 2.211f, 31.92f), Quaternion.identity);
        Instantiate(gatePrefabs[Random.Range(0, gatePrefabs.Length)], new Vector3(2.342f, 2.211f, 31.92f), Quaternion.identity);
